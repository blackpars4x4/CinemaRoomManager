...
Stage 5/5: Errors_
Description
Running a cinema theatre is not an easy business. To help our friends, let's add statistics to your program.
...
different seat coordinates until they pick an available seat. Of course, you shouldn't allow coordinates that
are out of bounds. If this happens, print Wrong input! and ask to enter different seat coordinates until the user
picks an available seat.
Examples
